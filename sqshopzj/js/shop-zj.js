...
// 返回顶部
// 先注册滚动事件
var toTop = document.querySelector('.cbl li:nth-child(4)');
var sc_height =0;
window.onscroll = function (){
    sc_height = document.documentElement.scrollTop || document.body.scrollTop;
...
// }
$('.cbl li:nth-child(4)').click(function(){
    $('html').animate({
        scrollTop:0
    },500)
})